...
<div class="dashboard__contenedor">
            ...
            <?php foreach($profesor as $profesores) { ?>
                <tr class="table__tr">
                    ...
                    <td class="table__td--acciones">
                        <a class="table__accion table__accion--editar" href="/admin/profesores/informatica/editar?id=<?php echo $profesores->id; ?>">
    ...
    <?php } else { ?>
        <p class="text-center">No hay Profesores de Informatica Aún</p>
