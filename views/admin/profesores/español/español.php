...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton-mate" href="/admin/profesores/español/crear">
            ...
            <?php foreach($profesor as $profesores) { ?>
                <tr class="table__tr">
                    ...
                    <td class="table__td--acciones">
                        <a class="table__accion table__accion--editar" href="/admin/profesores/español/editar?id=<?php echo $profesores->id; ?>">
                            <i class="fa-solid fa-user-pen"></i>
                            editar
                        </a>

                        <form method="POST" action="/admin/profesores/español/eliminar" class="table__formulario">
