...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton-mate" href="/admin/profesores/sociales/crear">
...
<div class="dashboard__contenedor">
            ...
            <?php foreach($profesor as $profesores) { ?>
                <tr class="table__tr">
                    ...
                    <td class="table__td--acciones">
                        <a class="table__accion table__accion--editar" href="/admin/profesores/sociales/editar?id=<?php echo $profesores->id; ?>">
                            <i class="fa-solid fa-user-pen"></i>
                            editar
                        </a>

                        <form method="POST" action="/admin/profesores/sociales/eliminar" class="table__formulario">
    ...
    <?php } else { ?>
        <p class="text-center">No hay Profesores de Sociales Aún</p>
